...
class Bot(commands.Bot):
    ...
    async def event_notice(self, message: str, msg_id: str | None, channel: Channel | None):
        print(message, msg_id, channel)
        return await super().event_notice(message, msg_id, channel)
